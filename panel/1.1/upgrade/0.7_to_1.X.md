# Upgrading 0.7 Series to 1.X Series
This upgrade guide is for **upgrading from 0.7.X to 1.X.X**. If you are trying to do an upgrade on a 1.X Panel
please [use this guide instead](/panel/1.1/upgrade/1.X.md).
...
**You cannot use the old daemon to run servers with Pterodactyl Panel 1.1.**

Please see [Migrating to Wings](/wings/1.1/migrating.md) for instructions.
