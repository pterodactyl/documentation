...
&mdash; for example &mdash; `1.0.0-alpha.1` to `1.0.0-rc.5`. **Do not use this guide for upgrading from `0.7`.**
...
``` bash
curl -L https://github.com/pterodactyl/panel/releases/download/v1.0.0-rc.5/panel.tar.gz | tar -xzv
```
