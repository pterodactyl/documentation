...
## Update Crontab Configuration For Queue Listeners
Next up, you will need to change the existing cronjob. You'll want to open your crontab using `sudo crontab -e` and
...
After this, you need to add the following line.
