...
This upgrade guide is for **upgrading from 0.7.X to 1.X**. If you are trying to do an upgrade on a 1.X Panel
please [use this guide instead](/panel/1.0/upgrade/1.x.md).
...
**You cannot use the old daemon to run servers with Pterodactyl Panel 1.X.**
