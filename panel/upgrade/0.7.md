...
&mdash; for example &mdash; `0.7.3` to `0.7.11`. **Do not use this guide for upgrading from `0.6` or upgrading to `0.8`.**
...
``` bash
curl -L https://github.com/pterodactyl/panel/releases/download/v0.7.14/panel.tar.gz | tar --strip-components=1 -xzv
```
