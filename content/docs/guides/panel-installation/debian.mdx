---
title: Debian 11, 12 & 13
description: Install Pterodactyl Panel on Debian 11, 12, and 13
---
...
| **Debian** | 11 | ✅ | |
| | 12 | ✅ | |
| | 13 | ✅ | - MariaDB can be installed without the repo setup script<br/> - Redis can be installed without the Redis APT repository |
