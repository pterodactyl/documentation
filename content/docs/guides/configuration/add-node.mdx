...
description: Step-by-step guide to adding a new node to your Pterodactyl Panel
---
...
![Create Node Button](/community/config/nodes/pterodactyl_add_node_create_button.png)

## Information Required

![New Node Page](/community/config/nodes/pterodactyl_add_node_new_page.png)
...
<Callout type="info" title="OVH Users">
...
![Node Configuration](/community/config/nodes/pterodactyl_add_node_config.png)
