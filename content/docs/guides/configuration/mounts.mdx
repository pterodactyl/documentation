---
title: Using Mounts
description: Mount directories from the host file-system into server containers
---
...
<Callout type="info" title="Path in the container">
...
![Garry's Mod Mount Example](/gmod_mount_example.png)
