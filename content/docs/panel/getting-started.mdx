...
description: Complete guide to installing Pterodactyl Panel with all dependencies and initial configuration.
---
...
<Callout title="Looking for something simple to setup?">
...
<Callout type="warn">
If you plan to install the panel and Wings on the same host, you should check [Wings compatibility](/wings/1.0/configuration.md)
before doing so, or the software may not be fully functional.
</Callout>
