...
<Callout type="warn">
If you plan to install the panel and the wings on the same host, it's advice to check [Wings compatibility](/wings/1.0/configuration.md)
before or the software may not be fully fonctionnal.
</Callout>
