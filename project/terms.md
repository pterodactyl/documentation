...
**Yolks**  — Yolks is a collection of docker images that can be used with Pterodactyl's Egg system. A Docker Image contains everything needed to run a containerized application. (e.g. Java for a Minecraft Server)
